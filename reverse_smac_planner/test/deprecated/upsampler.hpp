...
#include "reverse_smac_planner/upsampler_cost_function.hpp"
#include "reverse_smac_planner/upsampler_cost_function_nlls.hpp"
...
/**
 * @class reverse_smac_planner::Upsampler
...
public:
  /**
   * @brief A constructor for reverse_smac_planner::Upsampler
   */
  Upsampler() {}

  /**
   * @brief A destructor for reverse_smac_planner::Upsampler
   */
  ~Upsampler() {}
