...
#ifndef REVERSE_SMAC_PLANNER__NODE_2D_HPP_
#define REVERSE_SMAC_PLANNER__NODE_2D_HPP_
...
/**
 * @class reverse_smac_planner::Node2D
...
public:
  ...
  /**
   * @class reverse_smac_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for reverse_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const uint64_t index);

  /**
   * @brief A destructor for reverse_smac_planner::Node2D
   */
  ~Node2D();
  ...
  void getNeighbors(
    ...
    reverse_smac_planner::Node2D * &)> & validity_checker,
...
#endif  // REVERSE_SMAC_PLANNER__NODE_2D_HPP_
