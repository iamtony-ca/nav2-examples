...
#ifndef REVERSE_SMAC_PLANNER__NODE_LATTICE_HPP_
#define REVERSE_SMAC_PLANNER__NODE_LATTICE_HPP_
...
#include "reverse_smac_planner/utils.hpp"
...
/**
 * @struct reverse_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for reverse_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class reverse_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for reverse_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const uint64_t index);

  /**
   * @brief A destructor for reverse_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    reverse_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
...
#endif  // REVERSE_SMAC_PLANNER__NODE_LATTICE_HPP_
