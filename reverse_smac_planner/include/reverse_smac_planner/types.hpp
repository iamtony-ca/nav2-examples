...
#ifndef REVERSE_SMAC_PLANNER__TYPES_HPP_
#define REVERSE_SMAC_PLANNER__TYPES_HPP_
...
/**
 * @struct reverse_smac_planner::SearchInfo
...
/**
 * @struct reverse_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for reverse_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
...
/**
 * @struct reverse_smac_planner::TurnDirection
...
/**
 * @struct reverse_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for reverse_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct reverse_smac_planner::LatticeMetadata
...
/**
 * @struct reverse_smac_planner::MotionPrimitive
...
#endif  // REVERSE_SMAC_PLANNER__TYPES_HPP_
