...
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""WinROS <-> Nav2 bridge node (hybrid Python implementation).
...
# Node
# ---------------------------------------------------------------------- #
class WinRosBridgeToNav2(Node):
    """Bridge between the WinROS supervisor and Nav2."""

    # ------------------------------------------------------------------ #
    # Construction / destruction
    # ------------------------------------------------------------------ #
    def __init__(self) -> None:
        super().__init__('winros_bridge_to_nav2_node')
        ...
        self.get_logger().info('excute, winros_bridge_to_nav2_node')
