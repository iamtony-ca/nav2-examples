...
#ifndef ADVANCED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
#define ADVANCED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
...
/**
 * @class advanced_graceful_controller::ParameterHandler
...
public:
  /**
   * @brief Constructor for advanced_graceful_controller::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destructor for advanced_graceful_controller::ParameterHandler
   */
  ~ParameterHandler();
...
#endif  // ADVANCED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
