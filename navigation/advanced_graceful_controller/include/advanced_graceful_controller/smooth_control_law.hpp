...
#ifndef ADVANCED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
#define ADVANCED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
...
/**
 * @class advanced_graceful_controller::SmoothControlLaw
...
public:
  /**
   * @brief Constructor for advanced_graceful_controller::SmoothControlLaw
   *
  ...
  /**
   * @brief Destructor for advanced_graceful_controller::SmoothControlLaw
   */
...
#endif  // ADVANCED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
