...
#ifndef REVERSE_SMAC_PLANNER__NODE_HYBRID_HPP_
#define REVERSE_SMAC_PLANNER__NODE_HYBRID_HPP_
...
#include "reverse_smac_planner/constants.hpp"
#include "reverse_smac_planner/types.hpp"
#include "reverse_smac_planner/collision_checker.hpp"
#include "reverse_smac_planner/costmap_downsampler.hpp"
#include "nav2_costmap_2d/costmap_2d_ros.hpp"
#include "nav2_costmap_2d/inflation_layer.hpp"

namespace reverse_smac_planner
{
...
/**
 * @struct reverse_smac_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for reverse_smac_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class reverse_smac_planner::NodeHybrid
...
public:
  ...
  /**
   * @class reverse_smac_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for reverse_smac_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for reverse_smac_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const uint64_t index);

  /**
   * @brief A destructor for reverse_smac_planner::NodeHybrid
   */
  ~NodeHybrid();
  ...
  void getNeighbors(
    ...
    reverse_smac_planner::NodeHybrid * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
...
#endif  // REVERSE_SMAC_PLANNER__NODE_HYBRID_HPP_
