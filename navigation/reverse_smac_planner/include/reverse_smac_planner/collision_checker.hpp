...
#ifndef REVERSE_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define REVERSE_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace reverse_smac_planner
{

/**
 * @class reverse_smac_planner::GridCollisionChecker
...
public:
  /**
   * @brief A constructor for reverse_smac_planner::GridCollisionChecker
...
#endif  // REVERSE_SMAC_PLANNER__COLLISION_CHECKER_HPP_
