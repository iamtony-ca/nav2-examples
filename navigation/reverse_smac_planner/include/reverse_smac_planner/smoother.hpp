...
#ifndef REVERSE_SMAC_PLANNER__SMOOTHER_HPP_
#define REVERSE_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class reverse_smac_planner::PathSegment
...
/**
 * @struct reverse_smac_planner::BoundaryPoints
...
/**
 * @struct reverse_smac_planner::BoundaryExpansion
...
/**
 * @class reverse_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for reverse_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for reverse_smac_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // REVERSE_SMAC_PLANNER__SMOOTHER_HPP_
