...
#ifndef REVERSE_SMAC_PLANNER__A_STAR_HPP_
#define REVERSE_SMAC_PLANNER__A_STAR_HPP_
...
#include "reverse_smac_planner/thirdparty/robin_hood.h"
#include "reverse_smac_planner/analytic_expansion.hpp"
...
#include "reverse_smac_planner/node_basic.hpp"
...
/**
 * @class reverse_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct reverse_smac_planner::NodeComparator
  ...
  /**
   * @brief A constructor for reverse_smac_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for reverse_smac_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
...
#endif  // REVERSE_SMAC_PLANNER__A_STAR_HPP_
