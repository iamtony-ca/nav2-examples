...
#include "reverse_smac_planner/options.hpp"
...
/**
 * @struct reverse_smac_planner::UnconstrainedSmootherCostFunction
...
public:
  /**
   * @brief A constructor for reverse_smac_planner::UnconstrainedSmootherCostFunction
  ...
  {
    /**
     * @brief A constructor for reverse_smac_planner::CurvatureComputations
     */
