...
#ifndef AMR_BT_NODES__REMOVE_PASSED_GOAL_ACTION_HPP_
#define AMR_BT_NODES__REMOVE_PASSED_GOAL_ACTION_HPP_
...
class RemovePassedGoalAction : public BT::SyncActionNode
{
public:
  typedef std::vector<geometry_msgs::msg::PoseStamped> Goals;

  RemovePassedGoalAction(
...
#endif  // AMR_BT_NODES__REMOVE_PASSED_GOAL_ACTION_HPP_
