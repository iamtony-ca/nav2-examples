...
#include "static_smac_planner/options.hpp"
...
/**
 * @struct static_smac_planner::UnconstrainedSmootherCostFunction
...
public:
  /**
   * @brief A constructor for static_smac_planner::UnconstrainedSmootherCostFunction
  ...
  {
    /**
     * @brief A constructor for static_smac_planner::CurvatureComputations
     */
