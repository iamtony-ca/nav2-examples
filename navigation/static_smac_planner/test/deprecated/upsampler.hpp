...
#include "static_smac_planner/upsampler_cost_function.hpp"
#include "static_smac_planner/upsampler_cost_function_nlls.hpp"
...
/**
 * @class static_smac_planner::Upsampler
...
public:
  /**
   * @brief A constructor for static_smac_planner::Upsampler
   */
  Upsampler() {}

  /**
   * @brief A destructor for static_smac_planner::Upsampler
   */
  ~Upsampler() {}
