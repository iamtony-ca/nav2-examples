...
#include "static_smac_planner/smac_planner_lattice.hpp"
...
class LatticeWrap : public static_smac_planner::SmacPlannerLattice
{
public:
...
TEST(SmacTest, test_smac_lattice)
{
  ...
  auto planner = std::make_unique<static_smac_planner::SmacPlannerLattice>();
  try {
