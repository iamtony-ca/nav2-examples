...
#include "static_smac_planner/smac_planner_hybrid.hpp"
#include "static_smac_planner/smac_planner_2d.hpp"
...
TEST(SmacTest, test_smac_se2)
{
  ...
  auto planner = std::make_unique<static_smac_planner::SmacPlannerHybrid>();
