...
#ifndef STATIC_SMAC_PLANNER__NODE_2D_HPP_
#define STATIC_SMAC_PLANNER__NODE_2D_HPP_
...
/**
 * @class static_smac_planner::Node2D
...
public:
  ...
  /**
   * @class static_smac_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for static_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const uint64_t index);

  /**
   * @brief A destructor for static_smac_planner::Node2D
   */
  ~Node2D();
  ...
  void getNeighbors(
    ...
    static_smac_planner::Node2D * &)> & validity_checker,
...
#endif  // STATIC_SMAC_PLANNER__NODE_2D_HPP_
