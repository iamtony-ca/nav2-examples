...
#ifndef STATIC_SMAC_PLANNER__TYPES_HPP_
#define STATIC_SMAC_PLANNER__TYPES_HPP_
...
/**
 * @struct static_smac_planner::SearchInfo
...
/**
 * @struct static_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for static_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
...
/**
 * @struct static_smac_planner::TurnDirection
...
/**
 * @struct static_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for static_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct static_smac_planner::LatticeMetadata
...
/**
 * @struct static_smac_planner::MotionPrimitive
...
#endif  // STATIC_SMAC_PLANNER__TYPES_HPP_
