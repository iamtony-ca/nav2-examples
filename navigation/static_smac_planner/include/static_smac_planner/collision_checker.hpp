...
#ifndef STATIC_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define STATIC_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace static_smac_planner
{

/**
 * @class static_smac_planner::GridCollisionChecker
...
public:
  /**
   * @brief A constructor for static_smac_planner::GridCollisionChecker
...
#endif  // STATIC_SMAC_PLANNER__COLLISION_CHECKER_HPP_
