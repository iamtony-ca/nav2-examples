...
#ifndef STATIC_SMAC_PLANNER__A_STAR_HPP_
#define STATIC_SMAC_PLANNER__A_STAR_HPP_
...
#include "static_smac_planner/thirdparty/robin_hood.h"
#include "static_smac_planner/analytic_expansion.hpp"
...
#include "static_smac_planner/node_basic.hpp"
...
/**
 * @class static_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct static_smac_planner::NodeComparator
  ...
  /**
   * @brief A constructor for static_smac_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for static_smac_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
...
#endif  // STATIC_SMAC_PLANNER__A_STAR_HPP_
