...
#ifndef STATIC_SMAC_PLANNER__NODE_HYBRID_HPP_
#define STATIC_SMAC_PLANNER__NODE_HYBRID_HPP_
...
#include "static_smac_planner/constants.hpp"
#include "static_smac_planner/types.hpp"
#include "static_smac_planner/collision_checker.hpp"
#include "static_smac_planner/costmap_downsampler.hpp"
#include "nav2_costmap_2d/costmap_2d_ros.hpp"
#include "nav2_costmap_2d/inflation_layer.hpp"

namespace static_smac_planner
{
...
/**
 * @struct static_smac_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for static_smac_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class static_smac_planner::NodeHybrid
...
public:
  ...
  /**
   * @class static_smac_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for static_smac_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for static_smac_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const uint64_t index);

  /**
   * @brief A destructor for static_smac_planner::NodeHybrid
   */
  ~NodeHybrid();
  ...
  void getNeighbors(
    ...
    static_smac_planner::NodeHybrid * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
...
#endif  // STATIC_SMAC_PLANNER__NODE_HYBRID_HPP_
