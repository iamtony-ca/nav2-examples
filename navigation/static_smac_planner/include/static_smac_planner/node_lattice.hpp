...
#ifndef STATIC_SMAC_PLANNER__NODE_LATTICE_HPP_
#define STATIC_SMAC_PLANNER__NODE_LATTICE_HPP_
...
#include "static_smac_planner/utils.hpp"
...
/**
 * @struct static_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for static_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class static_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for static_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const uint64_t index);

  /**
   * @brief A destructor for static_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    static_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
...
#endif  // STATIC_SMAC_PLANNER__NODE_LATTICE_HPP_
