...
#ifndef STATIC_SMAC_PLANNER__SMOOTHER_HPP_
#define STATIC_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class static_smac_planner::PathSegment
...
/**
 * @struct static_smac_planner::BoundaryPoints
...
/**
 * @struct static_smac_planner::BoundaryExpansion
...
/**
 * @class static_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for static_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for static_smac_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // STATIC_SMAC_PLANNER__SMOOTHER_HPP_
