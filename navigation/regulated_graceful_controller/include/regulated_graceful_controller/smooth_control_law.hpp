...
#ifndef REGULATED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
#define REGULATED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
...
/**
 * @class regulated_graceful_controller::SmoothControlLaw
...
public:
  /**
   * @brief Constructor for regulated_graceful_controller::SmoothControlLaw
   *
  ...
  /**
   * @brief Destructor for regulated_graceful_controller::SmoothControlLaw
   */
...
#endif  // REGULATED_GRACEFUL_CONTROLLER__SMOOTH_CONTROL_LAW_HPP_
