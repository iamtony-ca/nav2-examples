...
#ifndef REGULATED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
#define REGULATED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
...
/**
 * @class regulated_graceful_controller::ParameterHandler
...
public:
  /**
   * @brief Constructor for regulated_graceful_controller::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destructor for regulated_graceful_controller::ParameterHandler
   */
  ~ParameterHandler();
...
#endif  // REGULATED_GRACEFUL_CONTROLLER__PARAMETER_HANDLER_HPP_
