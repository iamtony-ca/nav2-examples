...
#include "regulated_graceful_controller/ego_polar_coords.hpp"
...
class SCLFixture : public regulated_graceful_controller::SmoothControlLaw
{
public:
  SCLFixture(
  ...
  : regulated_graceful_controller::SmoothControlLaw(k_phi, k_delta, beta, lambda,
  ...
  {
    auto ego_coords = regulated_graceful_controller::EgocentricPolarCoordinates(target, current);
    return regulated_graceful_controller::SmoothControlLaw::calculateCurvature(
      ego_coords.r, ego_coords.phi, ego_coords.delta);
  }
};

class GMControllerFixture : public regulated_graceful_controller::GracefulController
{
public:
  GMControllerFixture()
  ...
  {
    return regulated_graceful_controller::createSlowdownMarker(
      motion_target,
  ...
  {
    return regulated_graceful_controller::GracefulController::rotateToTarget(
      angle_to_target);
  }
