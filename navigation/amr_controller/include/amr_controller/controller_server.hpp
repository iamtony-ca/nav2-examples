...
#ifndef AMR_CONTROLLER__CONTROLLER_SERVER_HPP_
#define AMR_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class amr_controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for amr_controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for amr_controller::ControllerServer
   */
  ~ControllerServer();
...
#endif  // AMR_CONTROLLER__CONTROLLER_SERVER_HPP_
