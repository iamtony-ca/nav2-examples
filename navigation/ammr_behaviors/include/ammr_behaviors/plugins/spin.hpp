...
#ifndef AMMR_BEHAVIORS__PLUGINS__SPIN_HPP_
#define AMMR_BEHAVIORS__PLUGINS__SPIN_HPP_
...
public:
  ...
  /**
   * @brief A constructor for ammr_behaviors::Spin
   */
  Spin();
  ~Spin();
...
#endif  // AMMR_BEHAVIORS__PLUGINS__SPIN_HPP_
