...
#include "advanced_graceful_controller/ego_polar_coords.hpp"
#include "advanced_graceful_controller/smooth_control_law.hpp"
#include "advanced_graceful_controller/graceful_controller.hpp"

class SCLFixture : public advanced_graceful_controller::SmoothControlLaw
{
public:
  SCLFixture(
  ...
  : advanced_graceful_controller::SmoothControlLaw(k_phi, k_delta, beta, lambda,
  ...
  {
    auto ego_coords = advanced_graceful_controller::EgocentricPolarCoordinates(target, current);
    return advanced_graceful_controller::SmoothControlLaw::calculateCurvature(
      ego_coords.r, ego_coords.phi, ego_coords.delta);
  }
};

class GMControllerFixture : public advanced_graceful_controller::GracefulController
{
public:
  GMControllerFixture()
  ...
  {
    return advanced_graceful_controller::createSlowdownMarker(
      motion_target,
  ...
  {
    return advanced_graceful_controller::GracefulController::rotateToTarget(
      angle_to_target);
  }
