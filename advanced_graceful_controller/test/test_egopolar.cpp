...
TEST(EgocentricPolarCoordinatesTest, constructorDefault) {
  advanced_graceful_controller::EgocentricPolarCoordinates coords;
...
TEST(EgocentricPolarCoordinatesTest, constructorWithValues) {
  ...
  advanced_graceful_controller::EgocentricPolarCoordinates coords(r_value, phi_value, delta_value);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPoses) {
  ...
  advanced_graceful_controller::EgocentricPolarCoordinates coords(target, current);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPose) {
  ...
  advanced_graceful_controller::EgocentricPolarCoordinates coords(target);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPosesBackward) {
  ...
  advanced_graceful_controller::EgocentricPolarCoordinates coords(target, current, true);
