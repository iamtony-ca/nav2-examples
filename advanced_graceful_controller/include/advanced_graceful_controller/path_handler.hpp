...
#ifndef ADVANCED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
#define ADVANCED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
...
/**
 * @class advanced_graceful_controller::PathHandler
...
public:
  /**
   * @brief Constructor for advanced_graceful_controller::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destructor for advanced_graceful_controller::PathHandler
   */
  ~PathHandler() = default;
...
#endif  // ADVANCED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
