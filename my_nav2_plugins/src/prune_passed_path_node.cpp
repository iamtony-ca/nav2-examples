...
#include "my_nav2_plugins/prune_passed_path_node.hpp"
...
PrunePassedPath::PrunePassedPath(
...
BT::PortsList PrunePassedPath::providedPorts()
{
  return {
...
BT::NodeStatus PrunePassedPath::tick()
{
...
{
  factory.registerNodeType<my_nav2_plugins::PrunePassedPath>("PrunePassedPath");
  // CheckBattery 노드도 같은 라이브러리에 있다면 여기에 함께 등록해야 합니다.
  // factory.registerNodeType<my_nav2_plugins::CheckBatteryCondition>("CheckBattery");
}