...
#ifndef AMMR_BEHAVIORS__TIMED_BEHAVIOR_HPP_
#define AMMR_BEHAVIORS__TIMED_BEHAVIOR_HPP_
...
protected:
  ...
  // Logger
  rclcpp::Logger logger_{rclcpp::get_logger("ammr_behaviors")};
...
#endif  // AMMR_BEHAVIORS__TIMED_BEHAVIOR_HPP_
