...
#ifndef AMMR_BEHAVIORS__PLUGINS__WAIT_HPP_
#define AMMR_BEHAVIORS__PLUGINS__WAIT_HPP_
...
public:
  ...
  /**
   * @brief A constructor for ammr_behaviors::Wait
   */
  Wait();
  ~Wait();
...
#endif  // AMMR_BEHAVIORS__PLUGINS__WAIT_HPP_
