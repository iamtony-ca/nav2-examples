...
#include "ammr_behaviors/behavior_server.hpp"
...
: LifecycleNode("behavior_server", "", options),
  ...
  default_ids_{"spin", "backup", "drive_on_heading", "wait", "graceful_spin"},
  default_types_{"ammr_behaviors::Spin",
    "ammr_behaviors::BackUp",
    "ammr_behaviors::DriveOnHeading",
    "ammr_behaviors::Wait",
    "ammr_behaviors::GracefulSpin"}
{
  declare_parameter(
    "local_costmap_topic",
