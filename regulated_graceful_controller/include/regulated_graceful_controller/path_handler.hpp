...
#ifndef REGULATED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
#define REGULATED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
...
/**
 * @class regulated_graceful_controller::PathHandler
...
public:
  /**
   * @brief Constructor for regulated_graceful_controller::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destructor for regulated_graceful_controller::PathHandler
   */
  ~PathHandler() = default;
...
#endif  // REGULATED_GRACEFUL_CONTROLLER__PATH_HANDLER_HPP_
