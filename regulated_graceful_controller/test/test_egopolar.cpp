...
TEST(EgocentricPolarCoordinatesTest, constructorDefault) {
  regulated_graceful_controller::EgocentricPolarCoordinates coords;
...
TEST(EgocentricPolarCoordinatesTest, constructorWithValues) {
  ...
  regulated_graceful_controller::EgocentricPolarCoordinates coords(r_value, phi_value, delta_value);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPoses) {
  ...
  regulated_graceful_controller::EgocentricPolarCoordinates coords(target, current);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPose) {
  ...
  regulated_graceful_controller::EgocentricPolarCoordinates coords(target);
...
TEST(EgocentricPolarCoordinatesTest, constructorFromPosesBackward) {
  ...
  regulated_graceful_controller::EgocentricPolarCoordinates coords(target, current, true);
